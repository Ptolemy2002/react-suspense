...
const SuspenseChild = styled.div`
...
export const SuspenseBoundary = partialMemo(function SuspenseBoundary({children, fallback, init, renderDeps=[]}) {
    ...
    return (
        ...
        <ProxyContextProvider 
            contextClass={SuspenseContext} value={valueRef.current} proxyRef={valueRef} onChange={onChange}
